...
public class Principal {
	public static void main(String[] args) {
		...
		if (result1.get(0).getClass().getSimpleName().equals("CutOff"))
		...
		System.out.println("--------------------------------------------------------------");
		printAcoes(result1, e);
		System.out.println("==============================================================");

		System.out.println("==============================================================");
		System.out.println("BuscaEmLargura");
		System.out.println("--------------------------------------------------------------");
		printAcoes(result2, e);
		System.out.println("==============================================================");

		System.out.println("==============================================================");
		System.out.println("BuscaEmLargura_v2_0");
		System.out.println("--------------------------------------------------------------");
		printAcoes(result3, e);
		System.out.println("==============================================================");

		System.out.println("==============================================================");
		System.out.println("BuscaAStar");
		System.out.println("--------------------------------------------------------------");
		printAcoes(result4, e);
		System.out.println("==============================================================");

		System.out.println("Elapsed time \n" + " BProf = " + (t1 - t0) + " (ms) \tNodos visitados : "
				+ bep.getMaxVisitSize() + "\tMax front: " + bep.getMaxFrontSize() + "\n" + " BLarg = " + (t2 - t1)
				+ " (ms) \tNodos visitados : " + bel1.getMaxVisitSize() + "\tMax front: " + bel1.getMaxFrontSize()
				+ "\n" + " BLarg_v2 = " + (t3 - t2) + " (ms) \tNodos visitados : " + bel2.getMaxVisitSize()
				+ "\tMax front: " + bel2.getMaxFrontSize() + "\n" + " BAstr = " + (t4 - t3)
				+ " (ms) \tNodos visitados : " + bas.getMaxVisitSize() + "\tMax front: " + bas.getMaxFrontSize());
	}

	private static void printAcoes(List<Acao> result4, Estado e) {
